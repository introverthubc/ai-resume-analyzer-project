...
function TierBar({ score }) {
  if (score == null) return <div className="text-xs text-[var(--ink-muted)]">Analyze this version to see its score.</div>;
  ...
  return (
    <div>
      ...
      <div className="h-[110px] -mx-1">
        <ResponsiveContainer initialDimension={{ width: 300, height: 230 }} width="100%" height="100%">
...
export function VersionStack({ versions, resumeId, resumeTitle }) {
  ...
  const TotalDeltaIcon = totalDelta > 0 ? TrendingUp : totalDelta < 0 ? TrendingDown : Minus;
        ...
        <div className="flex flex-col justify-between gap-4 lg:border-l lg:border-[var(--border)] lg:pl-5">
          ...
          <div className="space-y-2">
            ...
            >
              ...
              {totalDelta > 0 ? "+" : ""}
              {totalDelta == null ? "Awaiting analysis" : `${totalDelta} pts overall`}
            </div>
          </div>
