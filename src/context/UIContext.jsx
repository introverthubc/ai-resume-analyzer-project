...
export function UIProvider({ children }) {
  ...
  const toast = useMemo(() => ({
    send: sendToast,
    success: (title, description, opts) => sendToast({ title, description, variant: "success", ...opts }),
    error: (title, description, opts) => sendToast({ title, description, variant: "error", ...opts }),
    info: (title, description, opts) => sendToast({ title, description, variant: "info", ...opts }),
  }), [sendToast]);
